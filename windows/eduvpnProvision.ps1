...
{
	`$WireguardDate = Get-Content `"C:\Program Files\WireGuard\Data\wg0Expiry.txt`" | Get-Date
...
$action= New-ScheduledTaskAction -Execute "PowerShell.exe" -Argument "-executionpolicy bypass -File `"C:\Program Files\WireGuard\Data\renewal.ps1`"" # Specify what program to run and with its parameters
